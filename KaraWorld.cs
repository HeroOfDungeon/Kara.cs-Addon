    ...
    */
    public partial class KaraWorld : UserControl
    {
        ...
        public new void Move()
        {
            ...
            {
                System.Console.WriteLine("Baum im Weg");
            }
        }
        ...
        {
            int zeileBlatt = ckara.posXFront;
            int spalteBlatt = ckara.posYFront;
        ...
        public bool LeafRight()
        {
            int zeileBlatt = ckara.posXRight;
            int spalteBlatt = ckara.posYRight;
            if (world[spalteBlatt, zeileBlatt].Zellinhalt == Zelle.Inhalt.Kleeblatt)
            {
                return true;
            }
        ...
        public bool LeafLeft()
        {
            int zeileBlatt = ckara.posXLeft;
            int spalteBlatt = ckara.posYLeft;
            if (world[spalteBlatt, zeileBlatt].Zellinhalt == Zelle.Inhalt.Kleeblatt)
            {
                return true;
            }
